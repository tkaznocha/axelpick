      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl bg-card p-8 shadow-lg border border-black/5">
          ...
          <form action={(formData) => {
            ...
            <EmailButton label={mode === "login" ? "Sign in" : "Create account"} />
          </form>
...
function GoogleButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="flex w-full items-center justify-center gap-3 rounded-xl border border-black/10 bg-white px-4 py-3 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 disabled:opacity-60"
    >
      {pending ? (
        <>{spinner} Connecting...</>
      ) : (
...
function EmailButton({ label }: { label: string }) {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-emerald-600 disabled:opacity-60"
    >
